...
public class SqlHelper
{
    ...
    public static SqlDataAdapter ExecuteDataAdapter(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
    {
        if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
    ...
    public static DataTableReader ExecuteTableReader(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
    {
        if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
        SqlConnection connection = null;
        try
    ...
    #region ExecuteNonQuery via List Parameters

    public static int ExecuteNonQueryListParam(List<SqlParameter> paramList, string commandText)
    {
    ...
    #endregion ExecuteNonQuery via List Parameters

    #region GetDatatable via List Paramters

    public static DataTable GetDatatableListParam(List<SqlParameter> paramList, string commandText)
    {
        string conString = ConfigurationManager.ConnectionStrings["conStr"].ToString();
        SqlConnection con = new SqlConnection(conString);
        SqlCommand cmd = new SqlCommand();
    ...
    #endregion GetDatatable via List Paramters
}
