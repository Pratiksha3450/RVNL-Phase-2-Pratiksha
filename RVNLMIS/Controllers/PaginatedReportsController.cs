...
namespace RVNLMIS.Controllers
{
    ...
    //[Compress]
    [SessionAuthorize]
    public class PaginatedReportsController : Controller
    {
        ...
        public async Task<ActionResult> Index(string id)
        {
            ...
            embeddingData = await PbiEmbeddedManager.GetReportEmbeddingDataWithSecurity("1", values["Username"].ToString(), values["Role"].ToString()); // This is temparary commited
