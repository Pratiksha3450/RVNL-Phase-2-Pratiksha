...
namespace RVNLMIS.Controllers
{
    ...
    public class CapacitySuspendCronController : Controller
    {
        public void Index()
        {
            try
            {
                ...
                string apiUrl = string.Format("https://management.azure.com/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.PowerBIDedicated/capacities/{2}/suspend?api-version=2017-10-01", subscriptionId, resourceGroupName, capacityName);
                ...
                Logger.LogErrorToLogFile(DateTime.Now.ToString("dd-MMM-yyyy hh:mm tt") + "Capacity Suspend REST api response: " + response.StatusDescription);
            }
            catch (Exception ex)
            {
                Logger.LogInfo(ex);
